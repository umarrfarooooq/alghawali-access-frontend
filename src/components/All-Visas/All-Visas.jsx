            ...
            <div className="relative">
                ...
                <div>
                    <div className="bg-[#E3E3E3] my-4 rounded-xl md:px-4 px-2 py-2 w-full gap-2 flex items-center justify-between">
                        ...
                        <span className="text-sm md:text-base">All Profiles</span>
                        </div>
                        ...
                        <span className="text-sm md:text-base">Hired Profiles</span>
                        </div>
                    </div>
                </div>
                  ...
                  Array.isArray(visaData) && visaData.length > 0 ? (
                      visaData
                          ...
                          .sort((a, b) => {
                              ...
                              if (a.remainingDays.includes('Days Late') && !b.remainingDays.includes('Days Late')) {
                                  return -1;
                              } else if (!a.remainingDays.includes('Days Late') && b.remainingDays.includes('Days Late')) {
                                  return 1;
                              } else {
