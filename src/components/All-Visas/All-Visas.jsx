...
const calculateRemainingDays = (endDate) => {
    ...
    const totalOverstayedNonHiredProfiles = visaData
    .filter(visa => {
            ...
            <div className="relative">
                ...
                <div>
                    <div className="bg-[#E3E3E3] my-4 rounded-xl md:px-4 px-2 py-2 w-full gap-2 flex items-center justify-between">
                        <div onClick={() => handleTabClick("AllProfiles")} className={`${activeTab === "AllProfiles" ? "bg-[#FFFBFA] , shadow-md" : ""} transition-all rounded-lg gap-2 md:px-4 px-2 py-4 w-full flex items-center justify-center cursor-pointer`}>
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 17.7497C12.1989 17.7497 12.3896 17.6707 12.5303 17.53C12.6709 17.3894 12.7499 17.1986 12.7499 16.9997V10.9999C12.7499 10.801 12.6709 10.6102 12.5303 10.4696C12.3896 10.3289 12.1989 10.2499 12 10.2499C11.8011 10.2499 11.6103 10.3289 11.4697 10.4696C11.329 10.6102 11.25 10.801 11.25 10.9999V16.9997C11.25 17.4137 11.586 17.7497 12 17.7497ZM12 7C12.2652 7 12.5195 7.10535 12.7071 7.29288C12.8946 7.48042 12.9999 7.73476 12.9999 7.99997C12.9999 8.26518 12.8946 8.51952 12.7071 8.70705C12.5195 8.89459 12.2652 8.99994 12 8.99994C11.7348 8.99994 11.4804 8.89459 11.2929 8.70705C11.1054 8.51952 11 8.26518 11 7.99997C11 7.73476 11.1054 7.48042 11.2929 7.29288C11.4804 7.10535 11.7348 7 12 7Z" fill="#434146"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.25 11.9997C1.25 6.06285 6.06285 1.25 11.9997 1.25C17.9365 1.25 22.7493 6.06285 22.7493 11.9997C22.7493 17.9365 17.9365 22.7493 11.9997 22.7493C6.06285 22.7493 1.25 17.9365 1.25 11.9997ZM11.9997 2.74995C9.54649 2.74995 7.19379 3.72448 5.45913 5.45913C3.72448 7.19379 2.74995 9.54649 2.74995 11.9997C2.74995 14.4529 3.72448 16.8056 5.45913 18.5402C7.19379 20.2749 9.54649 21.2494 11.9997 21.2494C14.4529 21.2494 16.8056 20.2749 18.5402 18.5402C20.2749 16.8056 21.2494 14.4529 21.2494 11.9997C21.2494 9.54649 20.2749 7.19379 18.5402 5.45913C16.8056 3.72448 14.4529 2.74995 11.9997 2.74995Z" fill="#434146"/>
                            </svg>
                        </span>
                        <span className="text-sm md:text-base hidden sm:inline-block">All Profiles</span>
                        </div>
                        <div onClick={() => handleTabClick("Over Stay")} className={`${activeTab === "Over Stay" ? "bg-[#FFFBFA] , shadow-md" : ""} transition-all rounded-lg gap-2 md:px-4 px-2 py-4 w-full flex items-center justify-center cursor-pointer`}>
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 17.7497C12.1989 17.7497 12.3896 17.6707 12.5303 17.53C12.6709 17.3894 12.7499 17.1986 12.7499 16.9997V10.9999C12.7499 10.801 12.6709 10.6102 12.5303 10.4696C12.3896 10.3289 12.1989 10.2499 12 10.2499C11.8011 10.2499 11.6103 10.3289 11.4697 10.4696C11.329 10.6102 11.25 10.801 11.25 10.9999V16.9997C11.25 17.4137 11.586 17.7497 12 17.7497ZM12 7C12.2652 7 12.5195 7.10535 12.7071 7.29288C12.8946 7.48042 12.9999 7.73476 12.9999 7.99997C12.9999 8.26518 12.8946 8.51952 12.7071 8.70705C12.5195 8.89459 12.2652 8.99994 12 8.99994C11.7348 8.99994 11.4804 8.89459 11.2929 8.70705C11.1054 8.51952 11 8.26518 11 7.99997C11 7.73476 11.1054 7.48042 11.2929 7.29288C11.4804 7.10535 11.7348 7 12 7Z" fill="#434146"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.25 11.9997C1.25 6.06285 6.06285 1.25 11.9997 1.25C17.9365 1.25 22.7493 6.06285 22.7493 11.9997C22.7493 17.9365 17.9365 22.7493 11.9997 22.7493C6.06285 22.7493 1.25 17.9365 1.25 11.9997ZM11.9997 2.74995C9.54649 2.74995 7.19379 3.72448 5.45913 5.45913C3.72448 7.19379 2.74995 9.54649 2.74995 11.9997C2.74995 14.4529 3.72448 16.8056 5.45913 18.5402C7.19379 20.2749 9.54649 21.2494 11.9997 21.2494C14.4529 21.2494 16.8056 20.2749 18.5402 18.5402C20.2749 16.8056 21.2494 14.4529 21.2494 11.9997C21.2494 9.54649 20.2749 7.19379 18.5402 5.45913C16.8056 3.72448 14.4529 2.74995 11.9997 2.74995Z" fill="#434146"/>
                        ...
                        <span className="text-sm md:text-base relative">Over Stay 
                          <div className="bg-[#107243] w-5 h-5 flex items-center justify-center absolute -top-3 -right-6 rounded-full text-white">
                          <span className="text-xs">{totalOverstayedNonHiredProfiles}</span>
                          </div>
                        </span>
                        </div>
                        <div onClick={() => handleTabClick("HiredProfiles")} className={`${activeTab === "HiredProfiles" ? "bg-[#FFFBFA]  shadow-md" : ""} transition-all rounded-lg gap-2 md:px-4 px-2 py-4 w-full flex items-center justify-center cursor-pointer`}>
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-sm md:text-base hidden sm:inline-block">Hired Profiles</span>
                        </div>
                    </div>
                </div>
                ...
                {Array.isArray(visaData) && visaData.length > 0 ? (
                  visaData
                    ...
                    .sort((a, b) => {
                      ...
                      if (a.remainingDays.includes('Days Over Stay') && !b.remainingDays.includes('Days Over Stay')) {
                        return -1;
                      } else if (!a.remainingDays.includes('Days Over Stay') && b.remainingDays.includes('Days Over Stay')) {
                        return 1;
                      } else if (a.remainingDays.includes('Days Over Stay') && b.remainingDays.includes('Days Over Stay')) {
                        return parseInt(b.remainingDays) - parseInt(a.remainingDays);
                      } else {
                  ...
                  <div className="w-full border rounded-2xl border-solid p-6">
                    {
                      Array.isArray(visaData) && visaData.length > 0 ? (
                        ...
                        .sort((a, b) => {
                          ...
                          const lastExtensionA = a.extensionHistory && a.extensionHistory.length > 0 ? a.extensionHistory[a.extensionHistory.length - 1] : null;
                          const lastExtensionEndA = lastExtensionA ? new Date(lastExtensionA.newVisaEndDate) : visaEndA;
                          const overstayDaysA = today > lastExtensionEndA ? Math.floor((today - lastExtensionEndA) / (1000 * 60 * 60 * 24)) : 0;

                          const visaEndB = new Date(b.visaEndTime);
                          const lastExtensionB = b.extensionHistory && b.extensionHistory.length > 0 ? b.extensionHistory[b.extensionHistory.length - 1] : null;
                          const lastExtensionEndB = lastExtensionB ? new Date(lastExtensionB.newVisaEndDate) : visaEndB;
                          const overstayDaysB = today > lastExtensionEndB ? Math.floor((today - lastExtensionEndB) / (1000 * 60 * 60 * 24)) : 0;
