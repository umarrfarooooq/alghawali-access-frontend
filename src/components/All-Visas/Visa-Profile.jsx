  ...
  return (
    <>
      ...
      <div className="profileCard bg-[#FFFBFA] rounded-lg relative border border-solid p-4 mb-4 shadow-md">
        {showEditExtendForm && (
          <Grow in={showEditExtendForm}>
            <aside className="absolute z-[20] right-0 -mt-8">
              <UpdateOrExtendVisaForm
                visaValueData={visa}
        ...
        <Grow in={openVisaActions}>
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div
                onClick={toggleModal}
                className="deleteVisa cursor-pointer p-3 bg-[#EBEBEB] rounded-2xl"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 overflow-x-auto gap-y-4 gap-x-8 mt-4">
                  <div className="nationality ">
                    ...
                    <div className="text-sm font-semibold">
                      {formatDate(visa.dateEntry)}
                    </div>
                  </div>
                  <div className="religion ">
                    <div className="text-xs">Visa Duration</div>
                    <div className="text-sm font-semibold">
                      {calculateVisaDuration(visa.dateEntry, visa.visaEndTime)}
                    </div>
                  </div>
                  <div className="maritalStatus ">
                    <div className="text-xs">Remaining Days</div>
                    {visa.hiringStatus ? (
                      <div className="text-sm text font-semibold text-[#0C8B3F]">
                        Pause (Hired)
                      </div>
                    ) : (
                      <div
        ...
        {visa.extendedTime > 0 && (
          <div
            onClick={toggleHistoryBox}
            className="extensionHistoryAction cursor-pointer flex items-center justify-between my-4"
          >
        ...
        {historyOpen && (
          <div className="extensionHistory  mt-6">
            <div className="historyBoxes bg-[#F2F2F2] p-4 rounded-lg">
              {extensionHistory.map((history) => (
                <ExtensionHistory
                  ...
                  calculateVisaDuration={calculateVisaDuration}
                />
              ))}
            </div>
          </div>
