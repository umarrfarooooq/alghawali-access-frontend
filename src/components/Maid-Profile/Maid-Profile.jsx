  ...
  return (
    <>
      <div className="profileCard bg-[#FFFBFA] rounded-lg relative border border-solid p-4 mb-4 block lg:flex lg:items-start gap-4 shadow-md">
        {maid.isHired || maid.isMonthlyHired ? (
          <span>
            <span class="bg-yellow-100 absolute right-0 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300">
              {maid.isHired ? "Hired" : "Monthly Hired"}
            </span>
          </span>
        ) : (
          ""
        ...
        <div className="profileRightSide">
          <div className="maidName text-lg font-bold">{maid.name}</div>
            ...
            <div className="maidDetails overflow-y-auto max-w-full">
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 overflow-x-auto gap-y-4 gap-x-8 mt-4">
                ...
                <div className="whoAdd">
                  ...
                  <div className="text-sm font-semibold">
                    {maid.addedBy ? maid.addedBy : "Admin"}
                  </div>
                </div>
                {maid.isMonthlyHired && (
                  <div className="remainingDays">
                    ...
                    <div className="text-sm font-semibold">
                      {(() => {
                        ...
                        const endDate = new Date(maid.monthlyHireEndDate);
