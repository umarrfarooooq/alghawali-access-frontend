  ...
  const renderCountryCounts = () => {
    if (!details) {
      ...
      return details.map((country, index) => (
        <div
          key={index}
          className="flex items-center justify-between p-3 rounded-md bg-[#EBEBEB]"
        >
    ...
    <>
      {
        <div className="w-full sm:w-auto">
          <div
            ...
            } sm:w-[15rem] md:w-[19rem] xl:w-[22rem] p-4 bg-white shadow-lg rounded-lg flex flex-col gap-4`}
          >
