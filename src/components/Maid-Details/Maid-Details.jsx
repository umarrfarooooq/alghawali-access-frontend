    ...
    return(
        <>
            ...
            {maidDetails && 
                ...
                {isListAgainFormVisible && (
                        <aside className="absolute z-[20] right-0 w-screen sm:w-auto sm:mr-8 -mt-8">
                            <ListAgainForm costumerDetails={maidHistory} onCloseForm={toggleListAgainFormVisibility} />
                        </aside>
                )}
                ...
                {userRoles.includes(roles.canAccessOnAccounts) && <div>
                    <div className="bg-[#E3E3E3] rounded-xl md:px-4 px-2 py-2 w-full gap-2 flex items-center justify-between">
                        <div onClick={() => handleTabClick("profileInfo")} className={`${activeTab === "profileInfo" ? "bg-[#FFFBFA] , shadow-md" : ""} transition-all rounded-lg gap-2 md:px-4 px-2 py-4 w-full flex items-center justify-center cursor-pointer`}>
                        <span>
                        ...
                        <div onClick={() => handleTabClick("profileHistory")} className={`${activeTab === "profileHistory" ? "bg-[#FFFBFA]  shadow-md" : ""} transition-all rounded-lg gap-2 md:px-4 px-2 py-4 w-full flex items-center justify-center cursor-pointer`}>
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-sm md:text-base">Profile History</span>
                        </div>
                    </div>
                </div>}
                    ...
                    <div className="maidsCount flex items-center justify-between my-4">
                        ...
                        <div>
                            ...
                            {maidDetails.isHired ? <div onClick={toggleListAgainFormVisibility} className="cursor-pointer listHired p-4 text-[#262F32] bg-[#EBEBEB] border border-solid rounded-2xl text-xs">
                                ...
                                {userRoles.includes(roles.CanEditMaid) && <div className="editMaid cursor-pointer p-3 bg-[#EBEBEB] rounded-2xl"  onClick={toggleFormVisibility}>
                                    <div>
