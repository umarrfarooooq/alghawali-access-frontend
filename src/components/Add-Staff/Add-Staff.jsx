...
const AddStaffForm = ({ onCloseForm }) => {
  const { verifyToken, roles: staffRoles } = VerifyStaffToken();
          ...
          <div className="bg-[#F2F5FF] rounded-lg p-3 sm:p-8">
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div className="roles">
                <div className="mb-4">
                  <div
                    style={{ borderBottom: ".5px solid #C3D0D4" }}
                    class="flex items-center justify-between gap-2 mb-4"
                  >
                    <label
                      htmlFor="agentReq"
                      class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                    >
                      Show “Agents Requests” to this member?
                    </label>
                    <input
                ...
                <div className="mb-4">
                  ...
                  >
                    <label
                      ...
                      class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                    >
                      Show “Self Applied” to this member?
                    </label>
                    <input
                      onChange={handleCheckboxChange}
                      name="roles[]"
                ...
                <div className="mb-4">
                  ...
                  >
                    <label
                      htmlFor="plannedInterviews"
                      class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                    >
                      Show “Planned Interviews” to this member?
                    </label>
                    <input
                      onChange={handleCheckboxChange}
                      name="roles[]"
                      id="plannedInterviews"
                      type="checkbox"
                      value="4"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-2xl focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
                ...
                <div className="mb-4">
                  ...
                  >
                    <label
                      htmlFor="canAccessOnAccounts"
                      class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                    >
                      Have Access On Accounts?
                    </label>
                    <input
                      onChange={handleCheckboxChange}
                      name="roles[]"
                      id="canAccessOnAccounts"
                      type="checkbox"
                      value="128"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-2xl focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
                ...
                {staffRoles.includes(roles.fullAccessOnAccounts) && (
                  <div className="mb-4">
                    <div
                      style={{ borderBottom: ".5px solid #C3D0D4" }}
                      class="flex items-center justify-between gap-2 mb-4"
                    >
                      <label
                        htmlFor="fullAccessOnAccounts"
                        class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                      >
                        Full Access On Accounts?
                      </label>
                      <input
                        onChange={handleCheckboxChange}
                        name="roles[]"
                        id="fullAccessOnAccounts"
                        type="checkbox"
                        value="512"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-2xl focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                ...
                <div className="mb-4">
                  ...
                  >
                    <label
                      htmlFor="canAccessOnVisa"
                      class="mb-2 text-sm md:text-base font-medium text-[#434146]"
                    >
                      Have Access On Visa System?
                    </label>
                    <input
                      onChange={handleCheckboxChange}
                      name="roles[]"
              ...
              <div>
                <div class="mb-4">
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center text-sm font-semibold bg-[#107243] text-white md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2"
                  >
                    {spinningLoader && (
                      <img
                        className="w-8"
