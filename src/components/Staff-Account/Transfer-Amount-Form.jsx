...
const TransferAmountForm = ({ onCloseForm }) =>{
                ...
                {errorMessage && 
                  <div className="p-4 mb-4 w-full md:w-[26rem] text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        ...
                        <form onSubmit={handleFormSubmit}>
                            <div className="mb-4">
                                <label className="form-label block text-xl">Account Number</label>
                                <input type="text" className="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2" name="receiverId" />
                            </div>
                            <div className="mb-4">
                                <label className="form-label block text-xl">Amount</label>
                                <input type="number" className="w-full bg-[#E3E3E3] md:w-[26rem] h-[4rem] outline-none border-none rounded-lg px-2 py-2" name="amount" />
                            </div>
                            <div class="mb-4">
