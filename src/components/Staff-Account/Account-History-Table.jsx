const StaffAccountPaymentHistory = ({ paymentHistory, formatDate }) => {
  return (
    <>
      <div
        key={history._id}
      ...
      <div className="Entry">
        ...
        <div className="text-sm font-semibold">
          {formatDate(paymentHistory.date)}
        </div>
      </div>
        <div className="Entry">
        ...
        {paymentHistory.type === "Sent" ? (
          <div className="Entry">
            <div className="text-xs">Send To</div>
            <div className="text-sm font-semibold">
              {paymentHistory.sendedTo}
            </div>
          </div>
        ) : (
          <div className="Entry">
...
export default StaffAccountPaymentHistory;
