...
const StaffProfile = ({ staff }) => {
  ...
  const truncatedPassword =
    staff.password && staff.password.length > 10
      ? `${staff.password.slice(0, 10)}...`
      : staff.password;
    ...
    <>
      ...
      <div className="StaffCard bg-[#FFFBFA] rounded-xl border border-solid p-4 mb-4 block lg:flex lg:items-start gap-4 shadow-md">
        ...
        <div className="staffRightSide w-full">
          <div className="staffName text-lg font-bold">{staff.fullName}</div>
                ...
                <div className="editAndDelSvg flex items-center gap-4">
                  ...
                  >
                    <div>
                      ...
                      >
                        <path
                          d="M21 10V11.5C21 16.214 21 18.571 19.535 20.035C18.072 21.5 15.714 21.5 11 21.5C6.286 21.5 3.929 21.5 2.464 20.035C1 18.572 1 16.214 1 11.5C1 6.786 1 4.429 2.464 2.964C3.93 1.5 6.286 1.5 11 1.5H12.5"
                          stroke="#031D92"
                          stroke-width="1.5"
                          stroke-linecap="round"
                        />
                        <path
                          d="M15.6527 2.95512L16.3017 2.30612C16.8181 1.78988 17.5184 1.49991 18.2485 1.5C18.9787 1.50009 19.6789 1.79024 20.1952 2.30662C20.7114 2.823 21.0014 3.5233 21.0013 4.25347C21.0012 4.98365 20.7111 5.68388 20.1947 6.20012L19.5447 6.84912C19.5447 6.84912 18.1667 6.76812 16.9507 5.55112C15.7337 4.33512 15.6527 2.95612 15.6527 2.95612L9.68767 8.92012C9.28367 9.32412 9.08167 9.52612 8.90767 9.74912C8.70267 10.0111 8.52767 10.2961 8.38367 10.5971C8.26267 10.8521 8.17267 11.1231 7.99167 11.6651L7.41267 13.4001M7.41267 13.4001L7.03867 14.5221C6.99469 14.653 6.98808 14.7935 7.01959 14.9279C7.0511 15.0623 7.11948 15.1853 7.21705 15.2829C7.31461 15.3806 7.43749 15.4491 7.57186 15.4808C7.70623 15.5124 7.84677 15.506 7.97767 15.4621L9.10067 15.0881M7.41267 13.4001L9.10067 15.0881M19.5457 6.84812L13.5807 12.8131C13.1767 13.2171 12.9747 13.4191 12.7517 13.5931C12.4889 13.7981 12.2045 13.9738 11.9037 14.1171C11.6487 14.2381 11.3777 14.3281 10.8357 14.5091L9.10067 15.0881"
                          stroke="#031D92"
                          stroke-width="1.5"
                        />
                      </svg>
                  ...
                  <div
                    onClick={toggleModal}
                    className="deleteStaff cursor-pointer p-3 bg-[#EBEBEB] rounded-2xl"
                  >
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
