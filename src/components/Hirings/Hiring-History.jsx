const HiringHistory = ({ paymentHistory, formatDate }) => {
    return (
        <>
                <div key={history._id} className="historyRow p-3 flex items-center justify-between flex-wrap">
                    ...
                    <div className="VisaTime">
                        ...
                        <div className="text-sm font-semibold">{paymentHistory.totalAmount}</div>
                    </div>
                    <div className="Entry">
                        <div className="text-xs">Received Amount</div>
                        <div className="text-sm font-semibold">{paymentHistory.receivedAmoount}</div>
                    </div>
                    <div className="Entry">
                        <div className="text-xs">Remaining</div>
                        <div className="text-sm font-semibold">{paymentHistory.totalAmount - paymentHistory.receivedAmoount}</div>
                    </div>
                    <div className="Entry">
                    ...
                    <div className="Entry">
                        ...
                        <div className="text-sm font-semibold">{formatDate(paymentHistory.timestamp)}</div>
                    </div>
                    {paymentHistory.paySlip && <div className="Entry cursor-pointer bg-[#E3E3E3] p-3 rounded-2xl">
                        <a href={`${import.meta.env.VITE_API_URL}${paymentHistory.paySlip}`} download={`${import.meta.env.VITE_API_URL}${paymentHistory.paySlip}`}>
