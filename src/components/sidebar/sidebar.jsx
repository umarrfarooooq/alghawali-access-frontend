                        ...
                        <div className='flex flex-col gap-y-6 mt-[5rem] rounded-xl p-4'>
                                ...
                                <div>
                                    ...
                                    <li onClick={() => setActiveNav("Home")}>
                                        ...
                                        <Link to="/staff"
                                        className={`flex items-center p-4 rounded-lg ${activeNav === "Access Staff" ? "bg-[#107243] text-white transition-all" : "text-gray-900" } group`}>
                                        <svg stroke="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <Link to="/accounts" 
                                        className={`flex items-center p-4 rounded-lg ${activeNav === "Accounts" ? "bg-[#107243] text-white transition-all" : "text-gray-900" } group`}>
                                        ...
                                        <Link to="/visa" 
                                        className={`flex items-center p-4 rounded-lg ${activeNav === "Visas" ? "bg-[#107243] text-white transition-all" : "text-gray-900" } group`}>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
                                            height="24"
